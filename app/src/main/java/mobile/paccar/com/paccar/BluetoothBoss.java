...
public class BluetoothBoss {
    ...
    private IDataReceivedCallBack receivedDataCallback;

    public BluetoothBoss(Handler handler) {
//            setUpBT();
//            checkBTState();
        ...
        mNewState = mState;
        mHandler = handler;
        //receivedDataCallback = receivedCallback;
    }
            ...
            try {
                if (secure) {
                    tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME_SECURE,
                            BTMODULEUUID);
                } else {                                                                            //DON'T THINK WE NEED THIS NOT SUREEEEEEEEE
            ...
            try {
                if (secure) {
                    tmp = device.createRfcommSocketToServiceRecord(
                            BTMODULEUUID);
                } else {                                                                            // NOT SURE WE NEED THIS JSFJFFJKMAYBE
...
/*    private void setUpBT() {
    ...
    public void send(String data) {
        mConnectedThread.write(data); //transmitting JSON over bluetooth
    }
*/
public void send(String data) {
    mConnectedThread.write(data.getBytes()); //transmitting JSON over bluetooth
}
